# -*- coding: utf-8 -*-
"""Registra batch blog Limena GSC agosto 2026 in blog.html, admin, homepage.js, sitemap."""
...
REG = json.loads((ROOT / "scripts" / "limena_gsc_ago2026_registry.json").read_text(encoding="utf-8"))
MARKER = "blog-appartamento-limena-guida-acquisto-2026"
