# -*- coding: utf-8 -*-
"""Registra batch blog 15 giugno 2026 in blog.html, admin, homepage.js, sitemap."""
...
REG = json.loads((ROOT / "scripts" / "giugno15_blog_registry.json").read_text(encoding="utf-8"))
MARKER = "blog-compravendite-italia-q1-agenzia-entrate-2026-padova"
