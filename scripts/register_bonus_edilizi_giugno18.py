# -*- coding: utf-8 -*-
"""Registra blog bonus edilizi 18 giugno 2026 in blog.html, admin, homepage.js, sitemap."""
...
REG = json.loads((ROOT / "scripts" / "bonus_edilizi_giugno18_registry.json").read_text(encoding="utf-8"))
MARKER = "blog-bonus-edilizi-2026-incentivi-casa-padova"
