# -*- coding: utf-8 -*-
"""Registra batch blog housing Veneto luglio 2026 in blog.html, admin, homepage.js, sitemap."""
...
REG = json.loads((ROOT / "scripts" / "housing_veneto_lug2026_registry.json").read_text(encoding="utf-8"))
MARKER = "blog-stanza-universitaria-padova-canoni-2026"
...
def main() -> None:
    ...
    if MARKER in htext:
        ...
        for e in blog_entries:
            map_lines.append(js_static_map_entry(e["titolo"], e["immagine_copertina"], e["url_statico"]))
        map_block = "\n".join(map_lines)
