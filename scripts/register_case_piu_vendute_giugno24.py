# -*- coding: utf-8 -*-
"""Registra articolo case più vendute in blog.html, admin, homepage, sitemap."""
...
REG = json.loads((ROOT / "scripts" / "case_piu_vendute_registry.json").read_text(encoding="utf-8"))
MARKER = "blog-case-piu-vendute-tipologie-padova-2026"
