...
> **Gate obbligatorio agente:** **`TEST-SKILL/skill-massimo-punteggio.md`** — leggere prima di ogni modifica. **Premortem** (tutto il sito, ogni sfaccettatura nel diff, output con comandi — no chiacchere): **`TEST-SKILL/skill-premortem-righetto.md`** — `Premortem` / `/premortem` fino a prompt più efficace.
...
**4c) Homepage — Visite virtuali 360° (`#vtGridHome`, luglio 2026)**
