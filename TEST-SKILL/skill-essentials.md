...
18. **Comando editoriale fisso blog (agosto 2026 — PERMANENTE)** — **`TEST-SKILL/skill-editoriale-visivo.md`** + **`TEST-SKILL/skill-acquisizione-proprietari.md`** (priorità assoluta acquisizione proprietari/incarichi). Gate completi incl. `audit_editorial_acquisition.py`. Hub: `proprietario-immobile.html`.
