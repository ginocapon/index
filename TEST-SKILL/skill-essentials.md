...
18. **Comando editoriale fisso blog (agosto 2026 — PERMANENTE)** — **`TEST-SKILL/skill-editoriale-visivo.md`**: ricerca strategica §8–17 (3 aree, GSC/Trends, top 5 web, valore aggiunto Padova/Veneto) + visivo §1–7 (≥3 foto + ≥2 grafiche); gate `audit_editorial_research.py` + `audit_blog_visuals.py`. Precedenza su selezione argomento e composizione visiva.
