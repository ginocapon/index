...
14. **Foto annunci (luglio 2026)** — servite da `righettoimmobiliare.it/img/immobili/` (GitHub Pages). Dopo upload in admin: sync **automatico** ogni 6 h via `.github/workflows/sync-media-github.yml` su **server GitHub** — **PC spento non blocca** il sync; serve il PC solo per upload admin o sync urgente locale. Dettaglio: **`TEST-SKILL/skill-media-migration.md`**
